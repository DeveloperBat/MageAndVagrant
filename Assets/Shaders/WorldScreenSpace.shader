Shader "Tri-Planar World Normal" {
	Properties{
		...
		[NoScaleOffset] _Side("Side", 2D) = "gray" {}
		[NoScaleOffset] _Top("Top", 2D) = "gray" {}
		[NoScaleOffset]	_Bottom("Bottom", 2D) = "gray" {}

		_SideScale("Side Scale", Float) = 0.097656
		_TopScale("Top Scale", Float) = 0.097656
		_BottomScale("Bottom Scale", Float) = 0.097656

		[NoScaleOffset] _BumpMapSide("Side Normal Map", 2D) = "bump" {}
		[NoScaleOffset] _BumpMapTop("Top Normal Map", 2D) = "bump" {}
		[NoScaleOffset] _BumpMapBottom("Bottom Normal Map", 2D) = "bump" {}
